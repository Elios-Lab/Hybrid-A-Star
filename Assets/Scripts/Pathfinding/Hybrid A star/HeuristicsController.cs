...
namespace PathfindingForVehicles
{
    ...
    public static class HeuristicsController
    {
        ...
        public static void EuclideanDistance(Map map, IntVector2 targetCellPos)
        {
            ...
            euclideanHeuristics = new float[(int)(mapWidth / cellWidth), (int)(mapWidth / cellWidth)];
        ...
        public static void DynamicProgramming(Map map, IntVector2 targetPos)
        {
            ...
            FlowFieldNode[,] nodesArray = new FlowFieldNode[(int)(mapWidth / cellWidth), (int)(mapWidth / cellWidth)];
            ...
            //Save the values
            flowFieldHeuristics = new float[(int)(mapWidth / cellWidth), (int)(mapWidth / cellWidth)];
