...
namespace PathfindingForVehicles
{
    ...
    public static class HybridAStar
    {
        ...
        public static List<Node> GeneratePath(Car startCar, Car endCar, Map map, List<Node> allExpandedNodes, Car startTrailer)
        {
            ...
            HashSet<int>[,] closedCells = new HashSet<int>[(int)(mapWidth / cellWidth), (int)(mapWidth / cellWidth)];
            //The node in the cell with the lowest g-cost at a certain angle
            Dictionary<int, Node>[,] lowestCostNodes = new Dictionary<int, Node>[(int)(mapWidth / cellWidth), (int)(mapWidth / cellWidth)];
            //Trailer
            //int in the dictionaries below is the rounded heading used to enter a cell
            HashSet<int>[,] closedCellsTrailer = new HashSet<int>[(int)(mapWidth / cellWidth), (int)(mapWidth / cellWidth)];
            HashSet<int>[,] lowestCostNodesTrailer = new HashSet<int>[(int)(mapWidth / cellWidth), (int)(mapWidth / cellWidth)];
