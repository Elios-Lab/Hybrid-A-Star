    ...
    public static class ObstaclesDetection
    {
        ...
        public static HashSet<IntVector2> FindCellsOccupiedByRectangle(Rectangle rectangle, IntVector2 occupiedCell, Map map)
        {
            ...
            while (cellsToCheck.Count > 0)
            {
                ...
                for (int j = 0; j < delta.Length; j++)
                {
                    ...
                    if (!(testCell.x > 0 && testCell.x < (int)(map.MapWidth / map.CellWidth) && testCell.z > 0 && testCell.z < (int)(map.MapWidth / map.CellWidth)))
                    {
                        continue;
                    }
        ...
        public static void WhichCellsAreObstacle(Map map)
        {
            ...
            for (int x = 0; x < (int)(mapWidth / cellWidth); x++)
            {
                ...
                {
                    if (x == 0 || x == ((int)(mapWidth / cellWidth)) - 1 || z == 0 || z == ((int)(mapWidth / cellWidth)) - 1)
                    {
