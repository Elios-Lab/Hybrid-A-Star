...
public class DisplayDataOnTexture : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        // float cellWidth = Parameters.cellWidth;
    ...
    public void GenerateTexture_FlowField_DistanceToObstacle(Map map)
    {
        ...
        float[,] flowField = new float[(int)(mapWidth / cellWidth), (int)(mapWidth / cellWidth)];

        bool[,] isObstacle = new bool[(int)(mapWidth / cellWidth), (int)(mapWidth / cellWidth)];
    ...
    public void GenerateTexture_VoronoiDiagram(Map map)
    {
        ...
        Texture2D texture = GenerateNewDebugTexture((int)(mapWidth / cellWidth));

        //Generate the colors
        //More efficient to generate the colors once and then add the array to the texture
        Color[] colors = new Color[(int)((mapWidth / cellWidth) * (mapWidth / cellWidth))];
        ...
        for (int x = 0; x < (int)(mapWidth / cellWidth); x++)
        {
            for (int z = 0; z < (int)(mapWidth / cellWidth); z++)
            {
                ...
                colors[(int)(z * ((int)(mapWidth / cellWidth)) + x)] = thisColor;
            }
        }
