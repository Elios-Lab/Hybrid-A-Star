...
public class DisplayGrid : MonoBehaviour
{
    ...
    private void DisplayGridWithLines()
    {
        ...
        float gridSize = Parameters.mapWidth;
        ...
        for (int x = 0; x <= gridSize / cellSize; x++)
        {
            ...
            Vector3 lineEndX = new Vector3(xCoord, lineHeight, zCoord + (gridSize));
            ...
            Vector3 lineEndZ = new Vector3(zCoord + (gridSize), lineHeight, xCoord);
